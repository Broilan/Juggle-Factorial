...
const elements = [        { name: 'canvas', element: canvas },        { name: 'ctx', element: ctx },        { name: 'startBtn', element: startBtn },        { name: 'levelDisplay', element: levelDisplay },        { name: 'timerDisplay', element: timerDisplay },        { name: 'averageLevelDisplay', element: averageLevelDisplay },    ];
